...
$(function () {
    ...
    $(".form-button").click(function () {
        ...
        $.ajax({
            ...
            data:dataString,
            success:function () {
                $('#af-form').prepend("<div class=\"alert alert-success fade in\"><button class=\"close\" data-dismiss=\"alert\" type=\"button\">&times;</button><strong>Thank you for contacting Old Glory!</strong><br> We will be in touch soon.</div>");
                $('#af-form')[0].reset();
            }
        });
        return false;
